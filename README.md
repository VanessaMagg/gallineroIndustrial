...
**SmartFarm** es un sistema de automatización IoT para gallineros de pequeña escala, diseñado para una cooperativa de agricultores locales. El sistema controla y monitorea en tiempo real las condiciones ambientales (temperatura, humedad, luminosidad) y suministros (alimento, agua) para optimizar la producción de huevos orgánicos y garantizar el bienestar animal.

El proyecto fue construido siguiendo una metodología de **prototipado por etapas** con roles diferenciados de cliente y desarrollador, simulando un entorno profesional real de levantamiento de requerimientos, diseño aprobado y construcción iterativa.
...
│
├── 📂 etapa1-requisitos/
│   ├── PRD_GallineroSmart_v1.0.pdf     # Documento de Requerimientos firmado
│   └── acta_reunion_cliente.md         # Notas de la reunión de alineación
│
├── 📂 etapa2-diseno/
│   ├── gallinero_smart_mockup.html     # Mockup digital interactivo (interfaz agrícola)
│   ├── gallinero_industrial.html       # Mockup vista industrial / SCADA
│   ├── DFD_sensor_actuador.png         # Diagrama de flujo de datos
│   └── aprobacion_cliente.png          # Captura de firma digital del cliente
│
├── 📂 etapa3-prototipo/
│   ├── firmware/
...
│   ├── simulacion/
│   │   └── wokwi_link.txt              # Enlace al circuito en Wokwi
│   └── frontend/
...
La reunión de alineación cliente-desarrollador permitió definir el alcance del sistema. El **Grupo Cliente** (cooperativa) explicó la operativa diaria de la granja; el **Grupo Desarrollador** levantó requerimientos, definió criterios de aceptación, y consensuó un cronograma realista.
...
* **Mockup Digital Interactivo** — `gallinero_smart_mockup.html`  
...
* **Vista Industrial / SCADA** — `gallinero_industrial.html`  
...
* Ver enlace en `etapa3-prototipo/simulacion/wokwi_link.txt`
...
Acceso: abrir `gallinero_smart_mockup.html` en cualquier navegador moderno.
...
Acceso: abrir `gallinero_industrial.html` en cualquier navegador moderno.
...
open etapa2-diseno/gallinero_smart_mockup.html

# Mockup vista industrial
open etapa2-diseno/gallinero_industrial.html
```
...
1. Ir al enlace en `etapa3-prototipo/simulacion/wokwi_link.txt`
...
**Regla Áurea:** ningún grupo puede desarrollar el módulo que ellos mismos propusieron como clientes. El objetivo es practicar escucha activa, negociación de requerimientos, documentación técnica, y defensa de decisiones de diseño.
